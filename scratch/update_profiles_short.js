...
async function main() {
  try {
    console.log('Updating Jane profile to 700 words...');
...
Podsumowując, Jane to profesjonalna, kreatywna i autentyczna twórczyni treści adult, która wyróżnia się jakością, różnorodnością i zaangażowaniem w swoją pracę.`,
        avatar: '/image/Jane.jpg'
      }
    });
    console.log(`✅ Jane updated: description length ${jane.description.length} characters`);

    console.log('Updating Anna & Mark profile to 700 words...');
...
Podsumowując, Anna i Mark to autentyczna para, która wyróżnia się w branży adult swoją naturalną chemią, prawdziwą relacją i zaangażowaniem w swoją pracę.`,
    ...
    console.log('\n✨ Both profiles updated with ~700 words descriptions!');
  } catch (error) {
