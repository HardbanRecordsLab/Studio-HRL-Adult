    ...
    >
      ...
      <div className="p-8 pb-4 flex justify-between items-start relative z-10">
        <div className="flex items-center gap-4">
          <div
            className={`w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center text-3xl shadow-inner border border-white/5`}
          >
            {icon}
          </div>
          <div>
            <h3 className="text-xl font-bold text-white font-georgia italic uppercase tracking-tighter group-hover:text-[#c9a84c] transition-colors">
              {platform}
            </h3>
            <p className="text-[8px] text-gray-500 font-black uppercase tracking-[2px]">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="p-3 bg-white/5 rounded-xl text-gray-500 hover:text-[#c9a84c] hover:bg-[#c9a84c]/10 transition-all"
          >
      ...
      <div className="px-8 py-6 grid grid-cols-2 gap-6 relative z-10">
        <div className="space-y-1">
          <p className="text-[7px] text-gray-600 font-black uppercase tracking-widest flex items-center gap-1.5">
            <Users className="w-3 h-3 text-[#c9a84c]" /> Followers
          </p>
        ...
        <div className="space-y-1">
          <p className="text-[7px] text-gray-600 font-black uppercase tracking-widest flex items-center gap-1.5">
            <Layers className="w-3 h-3 text-blue-500" /> Assets
          </p>
          <p className="text-2xl font-bold text-white tracking-tighter">
            {(data.posts || 0).toLocaleString()}
          </p>
        </div>
      </div>
      ...
      <div className="px-8 pb-8 flex flex-wrap gap-2 relative z-10">
        {features.map((feature, i) => (
          <span
            key={i}
            className="px-3 py-1 bg-white/[0.02] border border-white/5 rounded-full text-[8px] font-black text-gray-500 uppercase tracking-widest group-hover:border-[#c9a84c]/20 group-hover:text-gray-400 transition-all"
          >
            {feature}
          </span>
        ))}
        ...
        {isEditing && (
          ...
          >
            <div className="space-y-6">
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <h4 className="text-[10px] font-black text-white uppercase tracking-[3px] flex items-center gap-2">
                  <Shield className="w-4 h-4 text-[#c9a84c]" /> Config:{" "}
                  {platform}
                </h4>
                <button
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-[7px] text-gray-600 uppercase tracking-widest font-black">
                    Platform Username
                  </label>
                  <input
                    type="text"
            ...
            <div className="flex gap-4 pt-6">
              <button
                onClick={() => setIsEditing(false)}
                className="flex-1 py-3 text-[9px] font-black text-gray-500 uppercase tracking-widest hover:text-white transition-all"
              >
                Cancel
              </button>
              <button
                onClick={handleSave}
                className="flex-1 py-3 bg-[#c9a84c]/10 text-[9px] font-black text-[#c9a84c] border border-[#c9a84c]/20 uppercase tracking-widest rounded-xl hover:bg-[#c9a84c] hover:text-black transition-all"
              >
                Zapisz Zmiany
              </button>
            </div>
