        ...
        >
          ...
          <div className="absolute inset-0 backface-hidden bg-dark-2 border border-gold/10 overflow-hidden flex flex-col z-10">
            <div className="flex-1 bg-gradient-to-br from-dark-3 via-dark-4 to-dark-3 relative overflow-hidden flex items-center justify-center">
              ...
              <div
                className="absolute inset-0 bg-cover bg-center opacity-60 group-hover:opacity-80 transition-all duration-700 scale-105 group-hover:scale-100"
                style={{
                  backgroundImage: `url('${profile.avatar || "/images/default-profile.jpg"}')`,
                }}
              ></div>
              <div className="absolute top-4 left-4 flex gap-2">
                {profile.tags.map((tag: string) => (
                  <span
                    key={tag}
                    className="text-[7px] tracking-[0.1em] uppercase px-2 py-0.5 bg-gold/10 text-gold border border-gold/20 backdrop-blur-sm"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="p-8 bg-dark-2 border-t border-gold/10 relative">
              ...
              <h3 className="font-playfair text-3xl text-white font-bold mb-1 relative z-10">
                {profile.name}
              </h3>
              <p className="text-gold text-[10px] tracking-[0.3em] uppercase relative z-10">
                {profile.handle}
              </p>
            </div>
          ...
          {/* Back Side: Short Bio */}
          <div className="absolute inset-0 backface-hidden bg-gradient-to-br from-dark-3 to-dark-4 border border-gold/30 p-8 flex flex-col justify-between rotate-y-180 [transform:rotateY(180deg)] z-20">
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Poznaj naszych topowych twórców tre adult. Premium content, profesjonalizm i ekskluzywne materiały."
        />
      </Head>
        ...
        <main>
            ...
            <div className="max-w-6xl mx-auto text-center relative z-10">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-dim font-light italic max-w-4xl mx-auto leading-relaxed">
                  Poznaj naszych topowych twórców. Każdy profil to gwarancja
                  jakości, profesjonalizmu i unikalnych treści.
                </p>
              </motion.div>
              ...
              >
                <div className="bg-dark-2/50 backdrop-blur-sm border border-gold/10 p-8 text-center">
                  <div className="text-4xl font-playfair text-gold font-bold mb-2">
                    5+
                  </div>
                  <div className="text-sm text-dim uppercase tracking-widest">
                    Aktywnych Twórców
                  </div>
                </div>
                <div className="bg-dark-2/50 backdrop-blur-sm border border-gold/10 p-8 text-center">
          ...
          <section className="py-32 px-[10%]">
            ...
            >
              ...
              <p className="text-dim text-lg font-light italic max-w-3xl mx-auto">
                Każdy z naszych twórców to profesjonalista z unikalnym stylem i
                podejściem do tworzenia treści.
              </p>
            </motion.div>
              ...
              {(!Array.isArray(profiles) || profiles.length === 0) &&
                !loading && (
                  <div className="col-span-full text-center py-20 bg-dark-2/30 border border-gold/10 rounded-2xl">
                    <p className="text-gold text-lg font-playfair italic mb-2">
                      Chwilowa przerwa w dostawie luksusu
                    </p>
                    <p className="text-dim text-sm uppercase tracking-widest">
                      Wróć za chwilę, nasze modelki właśnie się przygotowują.
                    </p>
                  </div>
                )}
            </div>
          ...
          <section className="py-32 px-[10%] bg-dark-2">
            ...
            >
              ...
              <p className="text-dim text-lg font-light italic max-w-3xl mx-auto">
                Premium doświadczenie z dostępem do ekskluzywnych treści od
                najlepszych twórców.
              </p>
            </motion.div>
