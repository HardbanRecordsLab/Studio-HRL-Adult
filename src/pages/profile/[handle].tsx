...
const PROFILES: Record<string, ProfileData> = {
  ...
  'anna-marek': {
    ...
    type: 'couple',
    name: 'Anna & Marek',
    tagline: 'Rzeczywista chemia & Wspólna pasja',
    eyebrow: 'Prawdziwa Para — Polska — Studio HRL Adult',
    bio: 'Jesteśmy parą która zmienia branżę adult content w Polsce. Nasza chemia jest naturalna, nasza pasja autentyczna, a nasze treści to naprawdę my - bez udawania. Tworzymy intymne, zmysłowe i profesjonalne materiały w studiu 4K, gdzie każda sekunda odzwierciedla naszę rzeczywistą relację i zabawie razem.',
    stats: [
      { val: '4.2k+', label: 'Subskrybentów' },
      { val: '240+', label: 'Filmów & sesji' },
      { val: '99%', label: 'Zadowolonych' },
    ],
    platforms: [
      { name: 'OnlyFans', url: '#', color: '#00AFF0', icon: '🔥' },
    ...
    plans: [
      { name: 'Couple Friend', price: '$7.99', period: '/mies.', desc: 'Podstawowy dostęp do naszych przygód', perks: ['80+ zdjęć miesięcznie', 'Klipy i teasery', 'Wiadomości & updates'], featured: false },
      { name: 'Intimate Insider', price: '$14.99', period: '/mies.', desc: 'Pełny dostęp do wszystkich treści', perks: ['Wszystkie wideo HD/4K', 'Live sessions 2-3x/tygodniowo', 'Custom requests', 'Behind-the-scenes'], featured: true },
      { name: 'VIP Experience', price: '$39.99', period: '/mies.', desc: 'Osobisty dostęp i spersonalizowana atencja', perks: ['Prywatne video sessions', 'Custom movie production', 'Direct messaging 24/7', 'Personalized couple scenarios'], featured: false },
    ],
    schedule: [
      { day: 'Wt', time: '21:00', active: true },
      { day: 'Cz', time: '20:30', active: true },
      { day: 'Pt', time: '22:00', active: true },
      { day: 'So', time: '21:30', active: true },
      { day: 'Nd', time: '20:00', active: false },
    ],
    testimonials: [
      { text: 'To jest autorytef! Widzieć jak naprawdę się lubią i jak mogą się bawić razem - to jest rare i piękne. Najlepsza para którą obserwuję na całej platformie.', name: 'CoupleEnthusiast', since: 'Fan od 1 roku' },
      { text: 'Ich chemia jest tak naturalna że aż boli. Nie widzieć żadnych udawań lub scenariuszy. Po prostu dwie osoby które się naprawdę lubią i dzielą się tym z nami.', name: 'AuthenticityFan', since: 'Fan od 10 miesięcy' },
      { text: 'Custom video było absolutnym szaleństwem! Wiedzieli dokładnie co zrobić, profesjonalne, zmysłowe i perfekcyjnie oddane. Zamawiamy co miesiąc!', name: 'RegularSupporter', since: 'Fan od 8 miesięcy' },
    ],
    contentCount: 20,
    isLive: true,
  },
