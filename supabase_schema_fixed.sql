...
CREATE UNIQUE INDEX IF NOT EXISTS "AcademyBlogArticle_slug_uidx" ON "AcademyBlogArticle"("slug");
...
-- Create storage buckets for file uploads (these need to be created manually in Supabase Dashboard)
...
-- Storage policies (these need to be created manually in Supabase Dashboard after creating buckets)
